/*
https://leetcode.com/problems/logger-rate-limiter/submissions/1589647224/
...
public class Logger {
    ...
    public boolean shouldPrintMessage(int timestamp, String message) {
        ...
        if (mem.containsKey(message)) {
            if (timestamp - mem.get(message) >= 10) {
                mem.put(message,timestamp);
                return true;
            }
        }
        else {
