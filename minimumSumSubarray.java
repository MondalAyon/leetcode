/*
https://leetcode.com/problems/minimum-positive-sum-subarray/submissions/1466871657/
...
public class minimumSumSubarray {
    public static void main(String[] args) {
        ...
        System.out.println(minimumSumSubarray(nums, l, m ));
